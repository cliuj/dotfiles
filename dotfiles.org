...
***** audio.pacman
:PROPERTIES:
:header-args: :text :tangle ./pkglists/audio.pacman
:END:
#+begin_src text
pavucontrol
pulseaudio
...
***** dev.pacman
:PROPERTIES:
:header-args: :text :tangle ./pkglists/dev.pacman
:END:
#+begin_src text
cabal-install
npm
...
***** fonts.pacman
:PROPERTIES:
:header-args: :text :tangle ./pkglists/fonts.pacman
:END:
#+begin_src text
...
***** tools.pacman
:PROPERTIES:
:header-args: :text :tangle ./pkglists/tools.pacman
:END:
#+begin_src text
bat
clang
...
***** ui.pacman
:PROPERTIES:
:header-args: :text :tangle ./pkglists/ui.pacman
:END:
#+begin_src text
arandr
alacritty
...
***** dev.yay
:PROPERTIES:
:header-args: :text :tangle ./pkglists/dev.yay
:END:
#+begin_src text
ghcup-hs-bin
#+end_src
***** tools.yay
:PROPERTIES:
:header-args: :text :tangle ./pkglists/tools.yay
:END:
#+begin_src text
carvel-tools
#+end_src
***** ui.yay
:PROPERTIES:
:header-args: :text :tangle ./pkglists/ui.yay
:END:
#+begin_src text
betterlockscreen
eww
